...
API_EDITS_OVER_TIME = "https://api.tinybird.co/v0/pipes/YOUR_edits_over_time_PIPE.json"
API_BOT_VS_HUMAN = "https://api.tinybird.co/v0/pipes/YOUR_bot_vs_human_PIPE.json"
API_TOP_SERVERS = "https://api.tinybird.co/v0/pipes/YOUR_top_servers_PIPE.json"
API_TOP_USERS = "https://api.tinybird.co/v0/pipes/YOUR_top_users_PIPE.json"
API_TOP_PAGES = "https://api.tinybird.co/v0/pipes/YOUR_top_pages_PIPE.json"
